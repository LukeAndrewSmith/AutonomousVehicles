...
REACTION_TIME=0 #-1            # float init_reaction_time  // 0 for autonomous vehicles
HUMAN=1                     # int init_human             // UNUSED HERE AS CONCERTINA
...
# Experiment
N_CARS_PER_LANE=10          # int init_n_cars_per_lane  // All lanes begin with the same number of cars
