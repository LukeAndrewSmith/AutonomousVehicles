...
TARGET_VELOCITY=15;         # float init_target_velocity
# Road
ROAD_LENGTH=0 #1000            # float init_road_length
SPEED_LIMIT=33              # float init_road_length    // 33 m/s =~ 120km/h
N_LANES=2                   # int init_n_lanes
BEGIN_EVENT=250             # float begin_event
# Experiment
N_CARS_PER_LANE=3           # int init_n_cars_per_lane  // All lanes begin with the same number of cars
CAR_SPACING=50              # int init_car_spacing
MAX_IT=0 #5000                 # int init_max_it
