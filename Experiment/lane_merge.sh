...
REACTION_TIME=0.25 #-1 #0 #0.25             # float init_reaction_time  // 0 for autonomous vehicles
HUMAN=1 #0                     # int init_human
...
# Experiment
N_CARS_PER_LANE=8 #14           # int init_n_cars_per_lane  // All lanes begin with the same number of cars
